...
export default function RegisterPage() {
    ...
    useEffect(() => {
        if (isAuthenticated) {
            console.log('✅ Already logged in, redirecting to /explore');
            router.push('/explore');
        }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success('Account created successfully! Welcome to Viral Prompts');
            router.push('/explore');
        } catch (error: any) {
    ...
    const ValidationItem = ({ isValid, text }: { isValid: boolean; text: string }) => (
        <div className="flex items-center gap-2 text-sm">
            ...
            <span className={isValid ? 'text-green-600 dark:text-green-400' : 'text-zinc-500'}>
                {text}
            </span>
        </div>
    );
                ...
                <Card className="shadow-xl border-zinc-200 dark:border-zinc-800">
                    <CardHeader className="space-y-1">
                        ...
                        <CardDescription className="text-center">
                            Join thousands of creators sharing amazing prompts
                        </CardDescription>
                    </CardHeader>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {formData.password && (
                                <div className="space-y-2 p-3 bg-zinc-50 dark:bg-zinc-900 rounded-md">
                                    ...
                                    <ValidationItem isValid={validations.hasSpecial} text="Contains a special character" />
                            ...
                            <Button
                                type="submit"
                                className="w-full h-11 bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700"
